...
\begin{document}
  ...
  \begin{description}
    ...
    the result that either (but not both!) of the following two lines would set the
  ...
  \begin{quote}
    \begin{tabular}{lll} \WebQuizTeX web
          ...
          \WebQuizTeX relative URL  &=& \BashCode|/UoS/WebQuiz|
      \end{tabular}
  \end{quote}
      ...
      \begin{description}
         ...
         \begin{description}
          ...
          \begin{description}
           ...
           \item[\ddash webquiztex-layout WEBQUIZ-LAYOUT]
