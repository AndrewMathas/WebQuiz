...
\begin{description}
  ...
  The currently supported languages are:
    ...
    Typical usage of gthe \textsf{language} option is the following:
    ...
    For example, the \textit{english} file file, which is the default,
    ...
    files, the material to the left of the equals signs should
    effectively variables, and so should not be changed, whereas
    anything the right of the equals signs is written as text in the
    \WebQuiz web pages. To add language support for a new language, say
    \textsf{XXX}, copy this file and translate the material to the right
    of the equals signs and then save the file as
    \texttt{webquiz-XXX.lang}, and put it anywhere in the \LaTeX{}
    search path. Note that the expressions \Verb|({})| in the language
    files should be kept because when used in the web pages they expand
    to expressions like \textsf(a), \textsf(b) etc. Once the new
    language file \texttt{webquiz-XXX.lang} is in the \LaTeX{} search
    path it can be used by \WebQuiz in the obvious way:
    \begin{latexcode}
    ...
    language files, to \href{https://\webquiz{repository}}{\webquiz{repository}}.
