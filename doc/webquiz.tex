...
\section{System requirements, installation and configuration}
  ...
  \CrossIndex{system requirements}{python}
    ...
    you will be prompted for the following:
    \begin{description}[labelwidth=18ex, itemsep=0mm]
      ...
      \item[hide-side-menu] do not display the side menu when quiz starts
    ...
    \end{description}
    The last three options are advanced options that you probably do not
...
option.
    ...
    \begin{description}
       \item[-h, --help] \CrossIndex{command-line options}{help}
          ...
          \BashCode|.webquizrc|, in your home directory or another file if you do
       ...
       errors, so using the \BashCode|--q| and \BashCode|\ddash qq| options is not
