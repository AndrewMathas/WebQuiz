...
\renewcommand\thesubsection{\Alph{subsection}}
  ...
  Please send new themes, and modifications to existing themes,  sent to me and to make
  modifications of existing themes, although there is a potential
  technical issue here in that the underlying \CSS files are written
  using \href{http://sass-lang.com/}{sass}.  Any new themes can be sent
  to me using the \textit{issue} tracker at
  \begin{quote}
  \href{https://\webquiz{repository}}{\webquiz{repository}}.
  \end{quote}
