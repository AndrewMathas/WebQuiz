...
\begin{description}
  ...
  Set the language used by the \textit{webpages} construted by \WebQuiz.
  ...
  \CrossIndex{system requirements}{python}
    ...
    \begin{itemize}
       ...
       or later, installed, because of recent changes to \TeX4ht{}.
        ...
        \autoref{SS:graphics} for more details.
        \item A web server
    \end{itemize}
...
\subsection{Special graphics configuration }
\label{SS:graphics}\index{graphics}
