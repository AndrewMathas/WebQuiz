...
\begin{document}
  ...
  \begin{description}
      ...
      The placement of the image is still not quite perfect, although
      this adjusts with the screen size and it does, in fact, displays
      well on a mobile device.  More importantly, if you use the
      \LatexCode|pst2pdf| document-class option then \WebQuiz is able to
      display this image.
