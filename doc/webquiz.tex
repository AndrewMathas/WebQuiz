...
\WebQuiz manual.  It does not index the \OnlineManual.}}
  ...
  correct answer as a string, which it must match exactly.
    ...
    \LatexCode|\answer*{Canberra}| in the last example then the quiz
    page looks like:
    \ScreenShot{A question with answer$*$}{examples/answer-star}

    The following code blocks and screen shots give examples of the
    different \LatexCode|\answer| comparison types, using the
    \LatexCode|\answer| command.
