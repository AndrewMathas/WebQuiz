...
\csdef{TeX4ht}{\href{https://www.ctan.org/tex4ht}{TeX4ht}\xspace}
...
\newcommand\OnlineManu{\href{http://www.maths.usyd.edu.au/u/mathas/WebQuiz/webquiz-online-manual.html}{\OnlineManual} (\hyperref[S:online]{Appendix B})}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{Credits}
 ...
 \label{S:documentclass}
  ...
  directory.% \footnote{Once \WebQuiz is initialised you can find the
...
\begin{description}
  ...
  The currently supported languages are:
    ...
    As a general rule, \LaTeX{} and \TeX4ht do not cope well with
...
\ctan{make4ht}, \ctan{pgf} and \TeX4ht. In fact, I recommend updating
...
\TeX4ht}\label{SS:config}\macroIndex{DisplayAsImage}

    The underlying engine used by \WebQuiz is \TeX4ht so, because
    \TeX4ht is not able process all \LaTeX{} code, there is \LaTeX{}
    code that \WebQuiz is not able to cope with.  This said, \TeX4ht is
  ...
  \WebQuiz uses \TeX4ht{} to convert the quiz content from \LaTeX{} to
  \HTML. If \TeX4ht{} has not been configured to for some of the commands
  ...
  to write appropriate \TeX4ht{} configuration commands, however, this
  can be tricky to do especially if you are not used to the inner
  workings of \TeX{} and \TeX4ht.

  \WebQuiz provides the command \LatexCode|\DisplayAsImage|, which essentially
  tells \TeX4ht to treat your command as an image when it creates the
  web page. This is an easy work-around that is much easier than writing
  your own \TeX4ht configuration commands and it often produces good
  ...
  to work with \TeX4ht, which means that this command does not work in
...
\section{System requirements, installation and configuration}
  ...
  \CrossIndex{system requirements}{python}
    ...
    Behind the scenes, \WebQuiz uses \TeX4ht, \python, \Javascript and
    ...
    The \WebQuiz program has three main components:
      \begin{itemize}
           ...
           \item Python3 executables that use \TeX4ht to convert \LaTeX\
    ...
    \begin{itemize}
       ...
       by \TeXLive. In particular, you need to have \TeX4ht{} and
...
\section{The WebQuiz program} \index{usage}
    ...
    almost all of the output produced by \LaTeX\ and \TeX4ht. The next
...
option.
    ...
    \begin{description}
       ...
       \item[\ddash webquiz-format WEBQUIZ-FORMAT]
    ...
    \begin{description}
      ...
      \begin{description}
        ...
        \item[make4ht]\index{make4ht}
          Options for \ctan{make4ht}. Rather than using \TeX4ht
  ...
  \subsection{Bugs, issues and feature requests}\index{bug reports}
    ...
    compiles using \TeX4ht directly.
