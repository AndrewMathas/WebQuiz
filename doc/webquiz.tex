...
\WebQuiz manual.  It does not index the \OnlineManual.}}
  ...
  \subsubsection{Index pages for qizzes}\label{SS:index}
    ...
    \begin{itemize}
      ...
      \ScreenShot{Drop-down menu giving index of quizzes}{examples/dropdown}
    ...
    \begin{description}
      ...
      \item[quizindex] This expands to ``Quizzes'', which is a link to
      ...
      \CrossIndex*{BreadCrumb}{quizindex}
