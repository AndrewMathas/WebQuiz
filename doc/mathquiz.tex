...
\subsection{Credits}
 ...
 \section{The MathQuiz document class --- \LaTeX{} commands}\label{S:documentclass}
...
discussion.
  ...
  set the data that \MathQuiz needs to construct them.
...
that \MathQuiz attempts to solve these problems for you.
...
\section{System requirements, installation and configuration}\label{S:configuration}
  ...
  \CrossIndex{system requirements}{python}
    ...
    The \MathQuiz program itself lives in the script directory. On a
    UNIX like system, which includes macs,  I recommend making a link to
    the file mathquiz.py, which is the entry point to the code, using
    something like:
    \begin{center}
    ...
    a windows batch file \Verb|mathquiz.bat| is included as part of
    \MathQuiz. \textit{I believe} that this batch file will allow you to run \MathQuiz
