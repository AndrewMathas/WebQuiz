...
var blank = {"marker": "",       "color": "black",  "bg": "#FFF8DC"};
var cross = {"marker": "\u2718", "color": "red",    "bg": "linear-gradient(to bottom right, white,  slateblue)"};
var star  = {"marker": "\u272D", "color": "yellow", "bg": "linear-gradient(to bottom right, yellow, green)"};
var tick  = {"marker": "\u2714", "color": "green",  "bg": "linear-gradient(to bottom right, red, yellow)"};
...
function toggle_dropdown_menu() {
    ...
    alert('Toggling drop down menu: display = '+quiz_menu.style.display)
    if (quiz_menu.style.display=="block") {
        quiz_menu.style.display="none";
        document.removeEventListener('click', close_drop_down);
        document.removeEventListener('click', close_drop_down);
    } else {
        alert('Setting display to block')
        document.addEventListener('click', toggle_dropdown_menu false);
