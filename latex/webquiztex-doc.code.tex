...
\usepackage{hologo}
\newcommand\WebQuizTeX{\texorpdfstring{WebQuizTeX}{\textcolor{brown}{WebQuiz\kern-0.5ex\hologo{TeX}}}\xspace}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% listings code for python and latex examples in webquiztex documentation
...
\lstdefinestyle{latexcode}{
  ...
  classoffset=2,
  morekeywords={quizindex, discussion, question, multiple, single, columns, choice, pspicture},
  classoffset=3,
  alsoletter=2,
  morekeywords={theme, language, hide side menu, pst2pdf, tikz, fixed order, random order, show side menu, one page,
                separate pages, english, french, integer, number, string, lowercase, eval},
  classoffset=4,
...
\lstdefinestyle{bashcode}{
  ...
  upquote=true,
  classoffset=1,
  morekeywords={webquiztex, kpsewhich, latex, pdflatex, xelatex. lualatex},
  classoffset=2,
  morekeywords={>}
}
...
\tcbuselibrary{skins}
\NewDocumentCommand\ScreenShot{ O{0.8} m O{examples/} m }{%
  \begin{center}
...
\AtEndPreamble{
  ...
  \hypersetup{%
      ...
      urlcolor=Brown,
      pdfauthor   = {\webquiztex{authors}                       },
      pdfkeywords = {\webquiztex{keywords}                      },
      pdfsubject  = {\webquiztex{description}                   },
      pdfinfo     = {%
          copyright    = {\webquiztex{copyright}},
