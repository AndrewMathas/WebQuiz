...
\ProvidesPackage{webquiz-doc}

% load webquiz-ini data
...
\lstdefinestyle{latexcode}{
  ...
  morekeywords={UnitCode,UnitName,UnitURL,QuizzesURL,BreadCrumbs,BreadCrumb,Institution,Department,
                ...
                Institution,InstitutionURL,response,correct,incorrect,whenRight,whenWrong,answer},
  classoffset=2,
...
\newcommand\InputLatexCode[1]{\lstinputlisting[style=latexcode]{#1}}
