...
<!--
    thisPage='%sQuizzes/%s.html'
    currentQ=%s
  -->
</script>
<script src="/u/mathas/mathquiz/mathquiz.js" type="text/javascript"></script>""" % ( doc.course[0]['url'], doc.course[0]['src'], currentQ)
  if len(doc.quizList)==0:
    menuScripts=""
  else:
    menuScripts="""<script type="text/javascript" src="/u/UG/newstyle/ResearchSubmenu.js"></script>
...
<script type="text/javascript" src="/u/UG/newstyle/SMSubmenu.js"></script>"""
  print """<link rel="stylesheet" href="/u/UG/styles/base_internal.css" type="text/css">
...
<script type="text/javascript" src="/u/UG/newstyle/QuizSubmenu.js"></script>%s
  """ % menuScripts
...
#    print '      color: %s;' % QuizColour[qnum % len(QuizColour)]
  ...
  space=   """    <tr>  <td height="5" colspan="3"><img src="/img/navy.gif" width="1" 
           height="1" alt="" vspace="5" class="decor"></td>
   </tr>"""

  thinline="""  <tr valign="top" bgcolor="#FFFFFF">
         <td class="menuDivLine" colspan="3"><img src="/img/navy.gif" width="1" height="2" 
           alt="" class="decor"></td>
   </tr>"""
  ...
  if len(doc.course[0]['name'])>0:
    ...
    if len(doc.quizList)==0:
      ...
      <td colspan="2" class="headerblue"><a href="%s" class="nav">%s</a></td>
  ...
  <td width="100%" class="nav"><a style="visibility: hidden;
  line-height: 0px" class="nav" href="/u/MOW/#quiz">quizzes</a><div class="dropdownroot" id="QuizSubmenu"></div><script type="text/javascript">
  ...
  if len(doc.questionList)>0:
    ...
    if len(doc.discussionList)==0:
      firstimage='%sborder1.gif' % gallery
    else:
      firstimage='%sclear1.gif' % gallery
    ...
    print '                 </td></tr>'
    print space
    imgTag = '    <tr>  <td class="nav"></td><td class="nav" colspan="2"><img alt="" src="'+gallery+'%s.gif" align="%s" height="%d" width="%d" border="0" hspace="2" vspace="2">'
  ...
  <td class="nav"><img src="/img/navy.gif" width="2" alt=""></td>
  <td valign="top" width="100%%"><img src="/img/navy.gif" alt="" height="10">
    <!-- start of main page -->
    <table width="100%%" cellspacing="0" cellpadding="6" bgcolor="#ffffff">
    <tr><td valign="top" width="0*" class="content">
<p>""" % ( VERSION, space, space )
...
<table width="100%%" border="0" cellspacing="0" cellpadding="0" class="role">
  <tr>
      <td colspan="2"><img src="/img/navy.gif" width="1" height="1" alt="" 
  ...
  <tr>
      <td style="background-image: url("""+Images+"""breadcrumb_blend.gif)" height="21" 
        nowrap class="breadcrumb">&nbsp;<a href="/" class="breadcrumb">Maths & Stats Home</a> /
      ...
      <table border="0" cellspacing="0">
        <tr>
	     ...
	     <a href="http://www.usyd.edu.au" class="global">USyd Home</a>&nbsp;</td>
  ...
  <tr>
    ...
    src="/img/navy.gif" width="1" height="1" hspace="100%%" alt=""  class="decor"></td>
  </tr>
</table>
<table width="100%%" border="0" cellspacing="0" cellpadding="0">
  <tr>
      <td colspan="20"><img src="/img/navy.gif" width="1" height="1" vspace="2" alt="" 
        class="decor"></td>
  </tr>
  <tr>
  ...
  <tr >
      <td colspan="20" bgcolor="#AD2431" class="tabnames"><img src="/img/navy.gif" width="1" height="1" alt="" hspace="250" class="decor">
    </td>
  </tr>
</table>
...
<tr>
  <td height="7" colspan="3" class="nav"><img src="/img/navy.gif" width="1" height="1" alt="" vspace="3"></td>
</tr>
<tr valign="top">
...
<tr>
  <td class="nav" colspan="3" height="6"><img src="/img/navy.gif" width="1" height="1" alt="" vspace="3"></td>
</tr>
<tr valign="top" bgcolor="#FFFFFF">
  <td class="menuDivLine" colspan="3"><img src="/img/navy.gif" width="1" height="2" alt="" class="decor"></td>
</tr>
...
<tr>
  <td height="7" colspan="3" class="decor"><img src="/img/navy.gif" width="1" height="1" alt="" vspace="3"></td>
</tr>
<tr valign="top">
  <td nowrap>&nbsp;<img src=\""""+Images+"""right_arrow.gif" alt="" width="9" height="9">&nbsp;</td>
...
<tr valign="top">
  <td nowrap >&nbsp;<img src=\""""+Images+"""right_arrow.gif" alt="" width="9"
height="9">&nbsp;</td>
  <td colspan="2"><a href="/u/UG/OR/" class="nav">Orange
</a></td>
</tr>
<tr>
  <td valign="top" colspan="3" class="decor"><img src="/img/navy.gif" width="1" height="1" alt="" vspace="3"></td>
...
<tr>
  <td height="7" colspan="3" class="navselected"><img src="/img/navy.gif" width="1" height="1" alt="" vspace="3"></td>
</tr>
<tr valign="top">
...
<tr valign="top">
  <td class="navselected" class="navselected"><img src="/img/navy.gif" width="1" height="1" alt=""></td>
