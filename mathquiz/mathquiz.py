...
def main():
    ...
    parser.add_argument('--settings', action='store_true', default=False, help='edit global settings for mathquiz')
    ...
    parser.add_argument('--mathjax', action='store', type=str, dest='mathjax', default=settings['mathjax'],
...
class MathQuizSettings(object):
    ...
    settings = dict(
        mathquiz_local = dict(val = 'mathquiz_local', help = 'Local python module that writes the HTML quiz web' ),
